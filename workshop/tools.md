...
- [Portfolio Building Ideas](https://github.com/florinpop17/app-ideas)
- [React Bits](https://reactbits.dev/)
    - Code snippets in React
- [CSS-Tricks](https://css-tricks.com/)

# Public Domain and OA Material:
...
## Toolkits and Free, Open Source UI/UX Elements:
- [Google Fonts](https://fonts.google.com/)
- [The League of Moveable Type](https://www.theleagueofmoveabletype.com/)
- [Velvetyne Type Foundry (fr)](https://velvetyne.fr/)
- [FontShare](fontshare.com)
- [Dirtyline Studio](https://dirtylinestudio.com/freebies/)
- [Textlab](https://textlab.javii.tools/)
    - Message bubbles and searchbar mockups/effects
- [Dither Garden](https://www.dithergarden.com/)
    - ASCII/dither effect from images
...
- [Figma Color Generator](https://www.figma.com/color-palette-generator/)